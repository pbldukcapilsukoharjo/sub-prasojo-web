      ...
      <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className="w-full bg-background text-text-primary text-sm font-medium rounded-xl border border-neutral h-11 px-4 focus:ring-2 focus:ring-[#8B0000]/25 focus:border-[#8B0000] focus:outline-none transition-all"
          />
