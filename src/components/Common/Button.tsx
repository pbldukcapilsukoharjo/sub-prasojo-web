...
export default function Button({ 
  ...
  else if (variant === 'ghost') variantClass = 'bg-transparent text-gray-700 hover:bg-gray-100 shadow-none border-transparent';
  else if (variant === 'outline') variantClass = 'bg-transparent border border-gray-300 text-gray-700 hover:bg-gray-50';
