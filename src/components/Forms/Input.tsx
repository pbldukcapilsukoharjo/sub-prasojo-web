  ...
  return (
    <div className={`flex flex-col gap-1.5 ${wrapperClassName}`}>
      ...
      <div className="relative">
        ...
        <input
          className={`w-full bg-[var(--surface-secondary)] text-gray-900 text-sm rounded-[30px] border border-[#E5E7EB] h-[44px] focus:ring-2 focus:ring-primary focus:outline-none transition-all ${
            icon ? 'pl-11' : 'pl-5'
          } pr-5 ${className}`}
          {...props}
        />
